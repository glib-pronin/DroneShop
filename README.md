...
- Усі сторінки сайту є адаптивними під різні прилади.
...
---
## Висновок  
Під час розробки цього проєкту я:

- поглибив знання Flask, архітектури та роботи з модулями;

- опанував інтеграцію реальних API (MonoPay та Нова Пошта);

- створив повноцінний особистий кабінет користувача;

- навчився працювати з платежами;

- впровадив систему сповіщень через Telegram.  
