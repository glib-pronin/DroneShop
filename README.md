...
- Оплата замовлення онлайн за допомогою MonoPay та LiqPay;
...
- Для адміністратора розроблений додатковий функціонал для зручним керуванням сайтом. 
...
- Liqpay-Python - бібліотека для інтеграції оплати за допомогою LiqPay.
...
### 1. MonoPay API
- **Роль:** обробка онлайн-оплати (Монобанк).
